...
public class Youtube_Login 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//Step 12:
		WebElement views=driver.findElement(By.xpath("//ytd-video-primary-info-renderer/div[@id='container']/div[1]//div[@id='count']/yt-view-count-renderer/span[1]"));
		String noOfViews=views.getText();
		
		//Step 13:
		String title=driver.getTitle();
		System.out.println("\n\nThe video clip played is : "+title);
		System.out.println("\n\nThe Total number of views are : "+noOfViews+"\n\n");
		
		//Step 14:
		if(title.contains("Always Angry"))
		{
			System.out.println("Number of views fetched for the clip - Case Passed");
		}
		else
		{
			System.out.println("Number of views NOT fetched for the clip - Case Failed");
		}
